...
Without a viewfinder, it was always an experience waiting in anticipation for the picture to slowly print out, accompanied by the rattling sound of the thermal printer, giving it the vibe of a Polaroid camera. Ripping the picture off like you would a receipt is also extremely satisfying.
