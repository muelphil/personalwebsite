...
short_abstract: "A fully custom DIY thermal printing camera I designed and build with a lot of additional features built into it."
title_image: 'Oskam/title_image'
title_image-caption: 'The Oskam'
read_time: 8
carousels:
  - images:
...
You can find a list of the installed PIP modules with their version [here (`pip list`)]({{'documents/Oskam-pip-list' | relative_url }}).
